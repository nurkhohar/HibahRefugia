    ...
    <script type="text/javascript">
        $(document).ready(function() {
            setInterval(function() {
                ...
                $('#apln').load("apln.php")
                $('#vpln').load("vpln.php")
                $('#aload').load("aload.php")
                $('#vload').load("vload.php")
            }, 500);
        });
    </script>
        ...
        <div style="width:620px; height : 330px; border-radius:30px;  background: rgb(12, 192, 223); clip-path: polygon();">
            ...
            <table style="width:100%" align="center">
                <tr>
                    ...
                    <td>
                        <div style="width:10px; height : 330px; border-radius:10%;  background: rgb(12, 192, 223); clip-path: polygon(); " align="center"> </div>
                    </td>
