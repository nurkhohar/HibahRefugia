...
<body>
  <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
    ...
    <a href="../panel/index.php" class="w3-bar-item w3-button">Home</a>
    <a href="../charging/charging1.php" class="w3-bar-item w3-button">Charging 1</a>
    <a href="../charging/charging2.php" class="w3-bar-item w3-button">Charging 2</a>
    <a href="../charging/charging3.php" class="w3-bar-item w3-button">Charging 3</a>
    <a href="../charging/charging4.php" class="w3-bar-item w3-button">Charging 4</a>
  </div>
  ...
  <table style="width:100%" align="center">
    <tr>
      <td align="center">
        <div style="width:620px; height : 330px; border-radius:30px;  background: rgb(12, 192, 223); clip-path: polygon();">
          <h1>Charging 2</h1>
          <table style="width:100%" align="center">
            <tr>
              <td>
              ...
              <td>
                <div style="width:10px; height : 330px; border-radius:30px;  background: rgb(12, 192, 223); clip-path: polygon(); " align="center"> </div>
              </td>
  ...
  <table style="width:100%" align="center">
    <tr>
      <td align="center">
        <div style="width:400px; height : 250px; border-radius:30px;  background: rgb(12, 192, 223); clip-path: polygon();">
          <h1>Baterai</h1>
          <br><br><br>
          <h1>
            <span id="baterai2">0</span>
